...
export const ROUTES = {
  ...
  LESSON_MATERIAL_TYPE: '/lessons/:lessonId/materials/:materialType',
  LESSON_MATERIAL_NEW: '/lessons/:lessonId/materials/:materialType/new',
  LESSON_MATERIAL_EDIT: '/lessons/:lessonId/materials/:materialType/:id/edit',
