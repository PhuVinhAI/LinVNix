...
export const LESSON_SECTIONS: LessonSectionMeta[] = [
  {
    ...
    label: 'Nội dung bài',
    description:
      'Tài liệu học viên đọc/nghe/xem khi vào bài: văn bản, hội thoại, âm thanh, hình ảnh, video — theo thứ tự trình bày.',
    hint: 'Văn bản, hội thoại, âm thanh, hình ảnh, video',
    Icon: FileText,
