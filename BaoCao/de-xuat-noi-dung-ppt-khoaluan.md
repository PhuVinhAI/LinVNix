...
Học liệu số tiếng Việt còn ít, học viên khó luyện giao tiếp thật. Đề tài xây nền tảng học tiếng Việt theo cấp độ, có AI hỗ trợ đúng ngữ cảnh, gồm ứng dụng di động và trang quản trị dùng chung một backend. Công nghệ chính: Flutter, React, NestJS, PostgreSQL, Redis.
...
- 6 thanh điệu, đổi thanh là đổi nghĩa: "ma, má, mà, mả, mã, mạ".
- 3 vùng phương ngữ Bắc, Trung, Nam, khác nhau chủ yếu ở phát âm.
- Người học hay sai: thanh điệu, phụ âm cuối, loại từ, trật tự từ.
