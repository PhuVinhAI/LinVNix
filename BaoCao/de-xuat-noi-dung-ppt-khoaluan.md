...
- 02 Thiết kế hệ thống: Kiến trúc, 4 tính năng AI, cơ sở dữ liệu.
- 03 Kết quả và Demo: Kết quả đạt được, hướng phát triển, demo trực tiếp.

**Slide 3 - Tổng quan đề tài** (nhãn nhỏ "01 · TỔNG QUAN")

- Học liệu số tiếng Việt còn ít, học viên khó luyện giao tiếp thật.
- Mục tiêu: nền tảng học tiếng Việt theo cấp độ, có AI hỗ trợ đúng ngữ cảnh.
- 3 thành phần: Ứng dụng di động, Trang quản trị, Backend dùng chung.
...
- CEFR chia 6 bậc A1-C2, Việt Nam có Thông tư 17/2015 tương ứng.
- 6 thanh điệu; đổi thanh là đổi nghĩa, ví dụ "vở" và "vợ".
- 3 vùng phương ngữ Bắc, Trung, Nam, khác nhau chủ yếu ở ngữ âm.
- Lỗi thường gặp: thanh điệu, phụ âm, danh từ phân loại, trật tự từ.
...
- Chatbot thường không biết tiến trình học của từng học viên.
- Agent được gọi công cụ để đọc dữ liệu thật trước khi trả lời.
- Cơ sở lý thuyết: suy luận, hành động, quan sát kết quả, gọi là ReAct.
- Nguyên tắc an toàn: công cụ chỉ được đọc, không tự sửa hoặc xóa dữ liệu.
...
- 12 ca sử dụng chính, từ đăng ký, học bài, đến các tính năng AI.
