...
- [ ] Profile stats section shows 2 new stat cards: "Scenarios Tried" + "Avg. Score"
- [ ] "Scenarios Tried" card shows `forum_outlined` icon + scenariosAttempted value
- [ ] "Avg. Score" card shows `star_outline` icon + averageScore value
