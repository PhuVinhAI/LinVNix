...
import 'package:linvnix/features/assistant/data/exercise_context_sanitizer.dart';
import 'package:linvnix/features/lessons/domain/exercise_models.dart';

Exercise _ex(
  ExerciseType type, {
  required ExerciseOptions options,
  required ExerciseAnswer correctAnswer,
}) {
  return Exercise(
    id: 'ex-${type.value}',
    exerciseType: type,
...
void main() {
  group('userAnswerForAssistantContext', () {
    test('null answer stays null', () {
      expect(
        userAnswerForAssistantContext(ExerciseType.multipleChoice, null),
        isNull,
      );
    });
    ...
    test('multiple_choice String passes through', () {
      expect(
        userAnswerForAssistantContext(ExerciseType.multipleChoice, 'A'),
        'A',
      );
    });
    ...
    test('listening/speaking transcript String passes through', () {
      expect(
        userAnswerForAssistantContext(ExerciseType.listening, 'xin chào'),
        'xin chào',
      );
      expect(
        userAnswerForAssistantContext(ExerciseType.speaking, 'xin chào'),
        'xin chào',
      );
    });
  });
