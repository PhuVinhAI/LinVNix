...
/// them as-is.
Object? userAnswerForAssistantContext(ExerciseType type, dynamic answer) {
  if (answer == null) return null;
  if (type == ExerciseType.matching && answer is List<MatchPair>) {
    return answer
...
Map<String, dynamic> optionsForAssistantContext(
  ...
  final raw = exercise.options.toJson();
